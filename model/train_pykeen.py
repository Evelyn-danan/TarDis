...
proj_name = f"{args.model}_{current_time}_{str(args.fold)}"
...
for i in range(1):
    data_fold = args.fold - 1
    train_data, test_data, train_data_id, test_data_id = load_train_data(args.data, entity2id, relation2id, data_fold)
    ...
    emb_trainning, emb_testing, emb_validation = emb_triplet.split([0.8, 0.1, 0.1], random_state=3930267)
